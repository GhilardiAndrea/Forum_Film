...
namespace Web_App_Forum_Film.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "{0} deve essere almeno {2} e al massimo {1} caratteri di lunghezza.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new MyUser { UserName = Input.Email, Email = Input.Email, Nome = Input.Nome, Cognome = Input.Cognome, Data_Nascita = Input.Data_Nascita, Nazione = Input.Nazione };
